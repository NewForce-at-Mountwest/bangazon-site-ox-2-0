...
namespace BangazonSite.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentTypeId,Name,acctNumber,isActive,UserId")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentTypeId,Name,acctNumber,isActive,UserId")] PaymentType paymentType)
        {
            var currentUser = await GetCurrentUserAsync();
